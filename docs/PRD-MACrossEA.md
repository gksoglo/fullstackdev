...
**Code folder:** Autotrader/MACrossEA_1.1 (staged modular rebuild — see Section 1 note on Stage 1 scope; this document describes the full target design, of which the staged rebuild currently implements Module A step 1 + Module B + Module D's Exit_Mode toggle — see the 1.11 Version History entry)
